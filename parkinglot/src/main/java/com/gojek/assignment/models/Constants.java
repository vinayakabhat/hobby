...
public class Constants {
	...
	public static final String STRING_SAPARATOR = "-";
	public static final String LEAVE = "leave";
	public static final String REGISTRATION_NUMBERS_FOR_CARS_COLOR = "registration_numbers_for_cars_with_colour";
	...
	public static final String READ_FILE = "read_from_file";
	public static final String DUMMY = "DUMMY_DATA";
